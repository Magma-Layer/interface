...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [ChainId.MAGMA_TESTNET]: [nativeOnChain(ChainId.MAGMA_TESTNET), WRAPPED_NATIVE_CURRENCY[ChainId.MAGMA_TESTNET] as Token,
  USDM,PNDC,WBTCMagma,EZBTC,ROCK],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.MAGMA_TESTNET]: [...WRAPPED_NATIVE_CURRENCIES_ONLY[ChainId.MAGMA_TESTNET], USDM],
