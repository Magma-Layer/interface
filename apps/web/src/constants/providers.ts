...
export const RPC_PROVIDERS: { [key in SupportedInterfaceChain]: StaticJsonRpcProvider } = {
  ...
  [ChainId.MAGMA_TESTNET]: providerFactory(ChainId.MAGMA_TESTNET),
  // [ChainId.OPTIMISM_SEPOLIA]: new StaticJsonRpcProvider,
  // [ChainId.ARBITRUM_SEPOLIA]: new StaticJsonRpcProvider
}
